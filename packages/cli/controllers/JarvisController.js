...
const { speakText, startVoiceInput, checkVoiceAvailability } = voiceService;
const { geminiApiKey, PROJECTS_DIR } = config;

const DiskAdapter = require('../adapters/DiskAdapter');

class JarvisController {
  constructor() {
    this.planner = new ProjectPlanner();
    const diskAdapter = new DiskAdapter();
    this.generator = new FileGenerator(diskAdapter);
